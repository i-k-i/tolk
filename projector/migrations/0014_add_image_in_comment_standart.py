...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TaskComment.image'
        db.delete_column(u'projector_taskcomment', 'image_id')
    ...
    def backwards(self, orm):
        # Adding field 'TaskComment.image'
        db.add_column(u'projector_taskcomment', 'image',
    ...
    models = {
        ...
        u'projector.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'2014-10-13 15:25:49.607453+00:00'", 'max_length': '200'}),
