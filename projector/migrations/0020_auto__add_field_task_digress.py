...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.digress'
        db.add_column(u'projector_task', 'digress',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.digress'
        db.delete_column(u'projector_task', 'digress')
    ...
    models = {
        ...
        u'projector.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'2014-11-20 14:28:20.095625+00:00'", 'max_length': '200'}),
