...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'projector_project', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(default='2014-09-24 10:22:15.995343+00:00', max_length=200)),
        ...
        db.create_table(u'projector_taskcomment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 9, 24, 0, 0))),
    ...
    models = {
        ...
        u'projector.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'2014-09-24 10:22:15.995343+00:00'", 'max_length': '200'}),
