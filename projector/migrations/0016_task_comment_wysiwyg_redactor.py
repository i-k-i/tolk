...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TaskComment.file'
        db.delete_column(u'projector_taskcomment', 'file')


        # Changing field 'TaskComment.comment'
        db.alter_column(u'projector_taskcomment', 'comment', self.gf('redactor.fields.RedactorField')())

    def backwards(self, orm):
        # Adding field 'TaskComment.file'
        db.add_column(u'projector_taskcomment', 'file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'TaskComment.comment'
        db.alter_column(u'projector_taskcomment', 'comment', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'projector.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'2014-10-17 16:14:41.273877+00:00'", 'max_length': '200'}),
        ...
        u'projector.taskcomment': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'comment': ('redactor.fields.RedactorField', [], {'default': "''"}),
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
