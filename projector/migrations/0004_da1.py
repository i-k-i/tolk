...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'projector_task', 'location',
                      self.gf('django.db.models.fields.CharField')(default='earth', max_length=200),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'projector_task', 'location')
    ...
    models = {
        ...
        u'projector.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'2014-09-24 16:04:00.051884+00:00'", 'max_length': '200'}),
