...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'projector_task', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['projector.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.project'
        db.delete_column(u'projector_task', 'project_id')
    ...
    models = {
        ...
        u'projector.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'2014-09-24 18:46:10.854889+00:00'", 'max_length': '200'}),
