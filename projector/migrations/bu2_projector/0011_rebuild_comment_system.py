...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TaskComment.comment'
        db.add_column(u'projector_taskcomment', 'comment',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


        # Changing field 'TaskComment.date'
        db.alter_column(u'projector_taskcomment', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'TaskComment.comment'
        db.delete_column(u'projector_taskcomment', 'comment')


        # Changing field 'TaskComment.date'
        db.alter_column(u'projector_taskcomment', 'date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'projector.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'2014-10-06 10:27:07.999526+00:00'", 'max_length': '200'}),
