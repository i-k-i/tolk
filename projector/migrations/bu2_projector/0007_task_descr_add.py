...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'projector_task', 'description',
                      self.gf('django.db.models.fields.TextField')(default='to do', max_length=600),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.description'
        db.delete_column(u'projector_task', 'description')
    ...
    models = {
        ...
        u'projector.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'2014-09-24 21:35:33.804179+00:00'", 'max_length': '200'}),
