...
#        db.delete_column(u'projector_task', 'finish_time')
        ...
        # Adding field 'Task.finish_date'
#        db.add_column(u'projector_task', 'finish_date',
#                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
#                     keep_default=False)

        db.rename_column(u'projector_task', 'finish_time', 'finish_date')
...
#                      keep_default=False)
        ...
        # Deleting field 'Task.finish_date'
 #       db.delete_column(u'projector_task', 'finish_date')
        db.rename_column(u'projector_task', 'finish_date', 'finish_time')
    ...
    models = {
        ...
        u'projector.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'2014-10-02 20:11:15.458334+00:00'", 'max_length': '200'}),
        ...
        u'projector.taskcomment': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 3, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
