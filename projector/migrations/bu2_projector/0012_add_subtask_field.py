...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.parent_task'
        db.add_column(u'projector_task', 'parent_task',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='subtask', null=True, to=orm['projector.Task']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.parent_task'
        db.delete_column(u'projector_task', 'parent_task_id')
    ...
    models = {
        ...
        u'projector.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'2014-10-06 18:58:43.095665+00:00'", 'max_length': '200'}),
