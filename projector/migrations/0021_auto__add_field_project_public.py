...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'projector_project', 'public',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'projector_project', 'public')
    ...
    models = {
        ...
        u'projector.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'2015-01-31 10:12:20.935401+00:00'", 'max_length': '200'}),
